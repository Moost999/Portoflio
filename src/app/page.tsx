    ...
    <div className={`min-h-screen ${darkMode ? 'bg-gray-900 text-white' : 'bg-gray-100 text-gray-900'}`}>
        ...
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
          <div className="flex items-center justify-between h-16">
            ...
            <div className="flex items-center space-x-4">
              <a href="#about" className="hover:text-blue-500 transition-colors">Experiencia</a>
              <a href="#skills" className="hover:text-blue-500 transition-colors">Habilidades</a>
              <a href="#projects" className="hover:text-blue-500 transition-colors">Projetos</a>
              <a href="#contact" className="hover:text-blue-500 transition-colors">Contate-me</a>
      ...
      <FadeInSection>
        <section id="skills" className="py-20 px-4">
          <div className="max-w-4xl mx-auto">
            <h2 className="text-3xl font-bold text-center mb-12">Skills | Habilidades</h2>
            ...
            <form onSubmit={handleSubmit} className="space-y-6">
              <div>
                ...
                <Input
                  id="email"
                  type="email"
                  placeholder="devmoost@gmail.com"
                  value={email}
